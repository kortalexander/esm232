...
Below is implementation of the function almond_yield to obtain the minimum, maximum, and mean yield anomalies.
...
#initiate function with parameter clim_data
almond_yield <- function(clim_data){
  
  #calculate monthly minimum temperatures and total precipitation per month
  ...
  #label output as yield anomaly, return max, min, and mean yield anomalies
