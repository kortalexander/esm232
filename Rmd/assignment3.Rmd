...
profit <- map_df(results,`[`, c("mean_profit"))
profit_params <- cbind.data.frame(profit, params)

#graph results
p1 = ggplot(profit_params, aes(baseline_yield, mean_profit, col=price_per_ton))+geom_point(cex=2)+
...
p2 = ggplot(profit_params, aes(price_per_ton, mean_profit, col=baseline_yield))+geom_point(cex=2)+
